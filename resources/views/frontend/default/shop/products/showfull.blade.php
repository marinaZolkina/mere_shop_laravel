...
<div class="row">
    <div class="col">
        @if ( !empty($product->photo) )
            {{ Html::image('/uploads/products/big/'.str_replace('images/', '', str_replace('.jpg', '', $product->photo)), $product->title, ['class'=>'img-responsive', 'style'=>'max-width:100%;']) }}
        @else
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                {{ Form::submit('In cart', ['class' => 'btn btn-primary btn-block']) }}
            </div>
        </div>
