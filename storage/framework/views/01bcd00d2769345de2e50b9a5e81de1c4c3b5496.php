...
<div class="card">
    <div class="card-body">
        <div class="form-group">
            ...
            <?php echo e(Form::text('name', null, ['class' => 'form-control', 'required' => 'required']), false); ?>

        </div>
        <div class="form-group">
            <?php echo e(Form::label('title', 'Email'), false); ?>

            <?php echo e(Form::email('email', null, ['class' => 'form-control','required' => 'required']), false); ?>
...
</div><?php /**PATH /var/www/html/simple_shop/lashop/resources/views/frontend/default/shop/cart/form.blade.php ENDPATH**/ ?>