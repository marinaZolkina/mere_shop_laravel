...
<div class="row">
    <div class="col">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <?php echo e(Form::submit('In cart', ['class' => 'btn btn-primary btn-block']), false); ?>
...
<?php echo $__env->make('frontend.'.config('template').'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/simple_shop/lashop/resources/views/frontend/default/shop/products/showfull.blade.php ENDPATH**/ ?>